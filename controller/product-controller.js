...
export const getProducts = async (request, response) => {
  try {
    ...
    if (!products) {
      return response.status(400).json({ message: "not working" })
    }
    return response.status(200).json(sampleProducts);
  }
  catch (error) {
